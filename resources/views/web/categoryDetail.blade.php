...
<div class="page-content">
    ...
    style="background-image: url('{{ $ProductCategory_detail->icon ? asset('images/product_categories/' . $ProductCategory_detail->icon) : asset('web/images/background/bg-shape.jpg') }}'); background-size: cover; background-position: center; min-height: 400px; display: flex; align-items: center;">
        <div class="container">
            <div class="dz-bnr-inr-entry text-center">
                <h1 class="text-white bg-dark p-4 rounded" style="opacity: 0.8;">Category Detail</h1>
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb d-inline-block"
                        ...
                        <li class="breadcrumb-item text-white">{{$ProductCategory_detail->name}} </li>
                    </ul>
                </nav>
            </div>
        </div>
