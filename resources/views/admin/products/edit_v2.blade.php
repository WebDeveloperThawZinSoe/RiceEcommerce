                            ...
                            <form action="{{ route('admin.product.update.v2.variant', $variant->id) }}" method="POST"
                                ...
                                <div class="mb-3">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <label for="expire_date_{{ $variant->id }}">Expire Date</label>
                                    <input type="text" class="form-control" name="expire_date"
                                        value="{{  $variant->expire_date }}" placeholder="Enter Expire Date">
                                </div>
            ...
            <form action="/admin/product/update/v2/variant/add" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                                    <label for="expire_dat">Expire Date</label>
                                    <input type="text" class="form-control" name="expire_date"
                                        value="" placeholder="Enter Expire Date">
                                </div>
